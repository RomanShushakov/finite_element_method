...
impl ForceComponent
{
    pub fn as_str(&self) -> &'static str
    {
        match self
        {
            ...
            ForceComponent::MembraneForceX => "MembraneForceX",
            ForceComponent::MembraneForceY => "MembraneForceY",
            ForceComponent::MembraneForceXY => "MembraneForceXY",
            ForceComponent::ShearForceXZ => "ShearForceXZ",
            ForceComponent::ShearForceYZ => "ShearForceYZ",
